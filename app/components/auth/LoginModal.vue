...
.auth-input { width: 100%; padding: 12px 15px; border: 1px solid #475569; border-radius: 6px; font-size: 1rem; box-sizing: border-box; background: #0f172a; color: #fff; }
...
.auth-btn { padding: 12px; border: none; border-radius: 6px; font-weight: 600; font-size: 1rem; cursor: pointer; transition: all 0.2s; }
